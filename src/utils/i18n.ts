...
const STRINGS: Record<Language, Record<string, string>> = {
    ...
    en: {
        ...
        "ask.fixPrompt": "Would you like Nova to analyze this error and generate a new solution? ({attemptsLeft} attempt(s) left)",
        "ask.fixCancelled": "Auto-Fix cancelled.",
        "ask.fixLimitReached": "Auto-Fix limit reached (3 attempts). Please resolve the issue manually.",
        "ask.exited": "Exited.",
        ...
        "provider.invalidBaseURL": "Invalid base URL: '{url}'. Must be a valid http/https URL.",
        "provider.invalidBaseURLHint": "Example: nova provider set openai --base-url https://api.groq.com/openai/v1",
        ...
        "update.dirtyWorktree": "Working directory has uncommitted changes. Please commit or stash them first.",
        "update.dirtyWorktreeHint": "Run: git stash   (then: git stash pop after update)",
        "update.ffOnlyFailed": "Cannot fast-forward merge. The branch has diverged.",
        "update.ffOnlyHint": "Run: git status   to inspect the state, then merge manually if needed.",
        "update.checkingGitHub": "Checking for updates on GitHub...",
        "update.downloading": "Applying update (git merge --ff-only)...",
        ...
        // Policy
        "policy.title": "Nova Project Policy",
        "policy.filePath": "Policy file: {path}",
        "policy.noFile": "No .nova-policy.json found in this project (or any parent directory).",
        "policy.noFileHint": "Create one with: nova policy init",
        "policy.initSuccess": "Policy file created: {path}",
        "policy.initExists": "Policy file already exists: {path}",
        "policy.addSuccess": "[OK] Rule added ({type}): {pattern}",
        "policy.addError": "Failed to add rule.",
        "policy.removeSuccess": "[OK] Rule removed: {pattern}",
        "policy.removeNotFound": "Rule #{index} not found. Run 'nova policy show' to see available rules.",
        "policy.removeError": "Failed to remove rule.",
        "policy.noRules": "No rules defined.",
        "policy.noRulesHint": "Add rules with: nova policy add deny \"<pattern>\" or nova policy add allow \"<pattern>\"",
        "policy.rulesTitle": "Active rules ({count}):",
        "policy.denyLabel": "DENY ",
        "policy.allowLabel": "ALLOW",
        "policy.reason": "reason: {reason}",
        "policy.deniedTitle": "BLOCKED by project policy",
        "policy.deniedReason": "Policy rule: {reason}",
        "policy.deniedHint": "This command is blocked by your .nova-policy.json rules.",
        "policy.allowedOverride": "[POLICY] Warning suppressed by project allow rule: {reason}",
        "policy.patternEmpty": "Pattern cannot be empty.",
        "policy.invalidType": "Type must be 'allow' or 'deny'.",
        "policy.parseError": "Failed to parse policy file: {path}",
        "policy.parseErrorHint": "The file contains invalid JSON. Fix or delete it, then retry.",
    },
    ...
    tr: {
        ...
        "ask.fixPrompt": "Nova bu hatayı analiz edip yeni bir çözüm üretsin mi? ({attemptsLeft} deneme hakkı kaldı)",
        "ask.fixCancelled": "Otomatik Düzeltme iptal edildi.",
        "ask.fixLimitReached": "Otomatik Düzeltme limiti aşıldı (3 deneme). Lütfen sorunu manuel olarak çözün.",
        "ask.exited": "Çıkıldı.",
        ...
        "provider.invalidBaseURL": "Geçersiz base URL: '{url}'. Geçerli bir http/https URL olmalı.",
        "provider.invalidBaseURLHint": "Örnek: nova provider set openai --base-url https://api.groq.com/openai/v1",
        ...
        "update.dirtyWorktree": "Çalışma dizininde kaydedilmemiş değişiklikler var. Önce commit veya stash yapın.",
        "update.dirtyWorktreeHint": "Çalıştırın: git stash   (güncellemeden sonra: git stash pop)",
        "update.ffOnlyFailed": "Fast-forward merge yapılamıyor. Dal ayrıştı.",
        "update.ffOnlyHint": "git status ile durumu inceleyin, gerekirse manuel birleştirin.",
        "update.checkingGitHub": "GitHub'da güncellemeler kontrol ediliyor...",
        "update.downloading": "Güncelleme uygulanıyor (git merge --ff-only)...",
        ...
        // Policy
        "policy.title": "Nova Proje Politikası",
        "policy.filePath": "Politika dosyası: {path}",
        "policy.noFile": "Bu projede (veya üst dizinlerde) .nova-policy.json bulunamadı.",
        "policy.noFileHint": "Oluşturmak için: nova policy init",
        "policy.initSuccess": "Politika dosyası oluşturuldu: {path}",
        "policy.initExists": "Politika dosyası zaten mevcut: {path}",
        "policy.addSuccess": "[OK] Kural eklendi ({type}): {pattern}",
        "policy.addError": "Kural eklenemedi.",
        "policy.removeSuccess": "[OK] Kural silindi: {pattern}",
        "policy.removeNotFound": "#{index} numaralı kural bulunamadı. 'nova policy show' ile mevcut kuralları görün.",
        "policy.removeError": "Kural silinemedi.",
        "policy.noRules": "Kural tanımlı değil.",
        "policy.noRulesHint": "Kural eklemek için: nova policy add deny \"<desen>\" veya nova policy add allow \"<desen>\"",
        "policy.rulesTitle": "Aktif kurallar ({count}):",
        "policy.denyLabel": "ENGELLE",
        "policy.allowLabel": "İZİN ",
        "policy.reason": "neden: {reason}",
        "policy.deniedTitle": "Proje politikası tarafından ENGELLENDİ",
        "policy.deniedReason": "Politika kuralı: {reason}",
        "policy.deniedHint": "Bu komut .nova-policy.json kuralları tarafından engelleniyor.",
        "policy.allowedOverride": "[POLİTİKA] Proje izin kuralı uyarıyı kaldırdı: {reason}",
        "policy.patternEmpty": "Desen boş olamaz.",
        "policy.invalidType": "Tür 'allow' veya 'deny' olmalıdır.",
        "policy.parseError": "Politika dosyası okunamadı: {path}",
        "policy.parseErrorHint": "Dosya geçersiz JSON içeriyor. Düzeltin veya silin, sonra tekrar deneyin.",
    },
};
